...
const MagicBento: React.FC<BentoProps> = ({
  ...
  return (
    ...
    className="absolute inset-0 flex flex-col justify-between p-5 text-white no-underline"
    style={{ zIndex: 10 }}
  >
                  <div className="card__header flex justify-between gap-3 relative text-white">
                    {/* <span className="card__label text-base">{card.label}</span> */}
                    <span className="card__label text-base font-bold text-center w-full block" style={{ color: '#00BFFF' }}> {card.label} </span>
